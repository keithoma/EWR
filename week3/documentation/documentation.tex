...
\epigraph{“Life is really simple, but we insist on making it complicated."}{\textit{Confucius}}
...
In this module, we first implemented the well known Euclidean algorithm which finds the greatest common divisor given two integers. From there, we use the result of the aforementioned algorithm to calculate the least common multiple.
